...
export default function AIAssistant() {
  ...
  const generateAIResponse = (userInput) => {
    const responses = {
      // 응답 예시 프롬프트
      누구: "저는 기아 AI 어시스턴트입니다. 무엇을 도와드릴까요?",
      ...
      "5000만원":
        "5000만원으로는 The Kia EV5로, 전기차를 추천해드립니다. 옵션으로는 드라이브 와이즈, 파노라마 선루프가 있습니다. 출시일은 2025-09-04 입니다! 이번 기회에 EV5 어떠신가요?",
      "2000만원":
        "2000만원으로는 The 2026 Ray를 추천해드립니다! 1.0 가솔린 엔진의 컴팩트카로, 배기량 998cc, 최대출력 76ps를 자랑합니다. 출시일은 2025-09-03이며, 클리어 화이트 색상이 기본입니다. 가격은 20,030,000원입니다. 효율적인 연비와 실용적인 디자인이 매력적인 모델입니다!",
      "7000만원":
        "7000만원으로는 The 2026 Carnival Hi-Limousine을 추천해드립니다! 3.5 가솔린 엔진의 7인승 시그니처 모델로, 배기량 3,470cc, 최대출력 294ps의 강력한 성능을 자랑합니다. 출시일은 2025-09-15이며, 스노우 화이트 펄 색상이 기본입니다. 프리미엄 팩, 스마트 커넥트 & HUD 등 다양한 옵션을 선택할 수 있습니다. 가격은 76,430,000원입니다. 넓은 실내공간과 고급스러운 편의사양이 특징입니다!",
      "확실해?": "확실해요! 저는 기아 AI 어시스턴트입니다.",
    };
